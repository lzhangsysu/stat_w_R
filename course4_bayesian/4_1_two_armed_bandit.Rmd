...
```{r E3}
data1 <- data.frame(machine = c(1,1), outcome = c("W", "W"))
data2 <- data.frame(machine = c(2,2,2), outcome = c("W","W","L"))
...
```{r E4}
bandit_posterior(data = data.frame(machine = c(1,1,2,2,2), outcome = c("W", "L", "W", "L", "L")))
```
...
```{r E5}
data = data.frame(machine = c(rep(1, 10), rep(2,10)), 
                  outcome = c("W", "L", "L", "L", "W", "W", "W", "W", "L", "W", 
                              "L", "L", "L", "L", "L", "L", "L", "W", "W", "L"))
...
```{r E6}
data = data.frame(machine = c(rep(1, 25), rep(2, 25)), 
                  outcome = c("L", "W", "W", "L", "L", "L", "W", "W", "L", "W", 
                              "L", "W", "L", "L", "L", "L", "W", "L", "W", "W", 
                              "L", "L", "L", "W", "L", "W", "W", "L", "L", "W", 
                              "W", "L", "W", "W", "W", "L", "W", "W", "L", "W", 
                              "L", "L", "L", "L", "W", "L", "W", "L", "L", "W"))
