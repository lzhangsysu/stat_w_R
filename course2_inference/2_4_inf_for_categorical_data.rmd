...
independence: random sampling, <10% of total population; sample size: np>10 & n(1-p)>10. n = 1002, p=5%, np = 50. Yes all met.
</div>
...
germany12 <- atheism %>%
  filter(nationality == "Germany" , atheism$year == "2012")

sum(germany12$response == 'atheist')/length(germany12$response)

inference(y = response, data = china12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

inference(y = response, data = germany12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
